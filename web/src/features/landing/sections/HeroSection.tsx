  ...
  return (
    <section className="relative min-h-[88vh] flex flex-col justify-center items-center pt-32 pb-16 px-6 overflow-hidden bg-radial-gradient">
      ...
      <div className="relative max-w-5xl mx-auto text-center z-10">
        ...
        {/* Precision Subtext */}
        <p className="max-w-2xl mx-auto text-base sm:text-lg text-foreground-muted leading-relaxed font-sans font-light mb-12">
        ...
        <div className="max-w-4xl mx-auto p-6 sm:p-8 rounded-xl bg-surface-200/50 border border-border/80 shadow-2xl backdrop-blur-sm mb-12">
        ...
        <div className="flex flex-col items-center gap-2">
          <a
            href="#problem"
            className="text-xs font-mono text-foreground-muted hover:text-foreground flex items-center gap-1.5 transition-colors group"
          >
            <span>Research Methodology & Results</span>
